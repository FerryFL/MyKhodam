        ...
        <div className="flex items-center justify-center h-screen bg-slate-700">
            <main className="text-center border border-4 max-w-xs md:max-w-xl p-4 border-[#A2D2FF]">
                <p className="text-md md:text-lg font-bold text-[#A2D2FF]">
                    Ini adalah v1 dari website MyKhodam 🖥️
                </p>
                <br></br>
                <p className="text-md md:text-lg font-bold text-[#A2D2FF] mb-5">
                    Website ini dibikin pake MERN stack. Website ini bakal dibikin v2nya, karna migrasi ke Next.js buat kepenting publish, SEO, dynamic routing, dll untuk fitur yang lebih kerenn...🤩
                </p>
